...
const translations: Translations = {
  ...
  'login.subtitle': { fr: 'Accédez à votre espace de gestion', en: 'Access your management dashboard' },
  ...
  'dashboard.todayShipments': { fr: 'Expéditions du jour', en: "Today's Shipments" },
  'dashboard.monthShipments': { fr: 'Expéditions du mois', en: "Month's Shipments" },
  ...
  'dashboard.recentShipments': { fr: 'Expéditions récentes', en: 'Recent Shipments' },
  ...
  'shipment.senderPhone': { fr: "Téléphone de l'expéditeur", en: 'Sender Phone' },
  ...
  'departure.selectShipments': { fr: 'Sélectionner les expéditions', en: 'Select Shipments' },
  ...
  'waybill.individual': { fr: 'Bordereau individuel', en: 'Individual Waybill' },
  ...
  // Distribution
  'distribution.title': { fr: 'Répartition des recettes', en: 'Revenue Distribution' },
